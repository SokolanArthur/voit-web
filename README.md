...
![Deploy Status](https://github.com/SokolanArthur/voit-web/actions/workflows/deploy.yml/badge.svg)
...
* **Управление секретами:** Пароли и логины не хранятся в коде. Значения подтягиваются в скрытый `.env` файл динамически на этапе выполнения GitHub Actions.
